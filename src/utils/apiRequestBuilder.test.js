...
describe('the apiRequestBuilder', () => {
  ...
  test('created lifecycle actions have the request key', () => {
  ...
  test('created lifecycle actions have the request steps', () => {
  ...
  test('uses requestParams for the request creator', () => {
    expect(testRequest.request('thingId')).toHaveProperty(
      'payload.id',
      'thingId',
    )
  })
  ...
  test('uses responseParams for the succeeded creator', () => {
    expect(testRequest.succeeded('data')).toHaveProperty(
      'payload.thing',
      'data',
    )
  })

  test('includes its request key', () => {
